...
type SellAuctionRepository interface {
	...
	CountActive(ctx context.Context, excludeOwnerID, filterRegionID int32, ownerJobKeys []string) (int64, error)
	Search(ctx context.Context, params sqlc.SearchSellAuctionsParams) ([]sqlc.SellAuction, error)
	CountSearch(ctx context.Context, searchTerm string, excludeOwnerID, filterRegionID int32, ownerJobKeys []string) (int64, error)
...
func (r *sellAuctionRepository) CountActive(ctx context.Context, excludeOwnerID, filterRegionID int32, ownerJobKeys []string) (int64, error) {
	return r.queries.CountActiveSellAuctions(ctx, sqlc.CountActiveSellAuctionsParams{
		OwnerJobKeys:          ownerJobKeys,
...
func (r *sellAuctionRepository) CountSearch(ctx context.Context, searchTerm string, excludeOwnerID, filterRegionID int32, ownerJobKeys []string) (int64, error) {
